...
function modelLoaded(){print('Model is loaded.')}
...
function gotPoses(results){
	if (results.length > 0){
		wristPos[0] = results[0].pose.rightWrist.x
		wristPos[1] = results[0].pose.rightWrist.y
...
function draw(){
	...
	if (gameStat == 'start'){
		...
		console.log(wristPos[0] + ', ' + wristPos[1])
		fill('#ff00ff')
		stroke('#ff00ff')
		circle(wristPos[0], wristPos[1], 25)
	} else {
